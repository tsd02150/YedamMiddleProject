...
public class LowPriceList implements Control {
	...
	public String execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<BoardVO> lowPriceList = ps.lowPriceList(page);
		...
		System.out.println("lowPriceList="+lowPriceList);
		return "product/lowPriceList.tiles";
	}
