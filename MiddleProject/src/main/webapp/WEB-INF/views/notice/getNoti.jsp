...
<form action="modifyNotiForm.do" method="get">
	<table class="table">
		...
		<tr>
			<td colspan="2" align="center"><c:choose>
					<c:when test="${id.equals('admin')}">
						<button type="button" onclick="location.href='modifyNotiForm.do?no=${vo.noticeNo}'">수정</button>
						<button type="button" onclick="location.href='delNoti.do?no=${vo.noticeNo}'">삭제</button>
					</c:when>
				</c:choose>
